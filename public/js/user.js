    ...
    send: {
        register: function () {
            socket.emit("user:register", {
                email: $("div#signIn input#email").val(),
                password: $("div#signIn input#password").val()
            });
        },
        signin: function () {
        ...
        settings: function () {
            socket.emit("user:settings", {
                email: $("div#userSettings input#email").val(),
                displayname: $("div#userSettings input#displayname").val(),
                token: user.info.token
            });
        },
        changePassword: function () {
            socket.emit("user:changepassword", {
                oldpassword: $("div#changePassword input#oldpassword").val(),
                newpassword: $("div#changePassword input#newpassword").val(),
                confirmpassword: $("div#changePassword input#confirmpassword").val(),
                token: user.info.token
            });
        }
    },
